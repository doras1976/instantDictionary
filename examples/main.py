...
def home():
    ...
    d_output = jp.Div(a=div1, text="Result goes here...", classes="tet-gray-600")
    jp.Div(a=div1, text="Just another div...", classes="tet-gray-600")
    jp.Div(a=div1, text="Yet another div...", classes="tet-gray-600")
    ...
    jp.Div(a=div2, text="I am a cool interactive div!", mouseenter=mouse_enter,
           ...
           classes="hover:bg-red-500 hover:text-white")
    return wp
